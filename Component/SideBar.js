                ...
                <aside className="flex flex-col items-center bg-white text-gray-700 shadow h-full">
                    ...
                    <ul>
                        <li className="hover:bg-gray-100">
                            <span className="h-16 px-6 flex justify-center items-center w-full focus:text-orange-500 cursor-pointer">
                                <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"> <polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline>
                        ...
                        <li className="hover:bg-gray-100">
                            <span
                                ...
                                <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"> <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
                                </svg>
                            </span>
                        </li>
                    </ul>
